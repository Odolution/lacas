/** @odoo-module alias=ol_school_manager.relational_fields */
...
const FieldEnrollFamilyOne2many = FieldOne2Many.extend({
    ...
    _renderButtons() {
        ...
        if (!this.isReadonly && this.view.arch.tag === 'kanban' && this.$buttons
            ...
            this.$buttons.on('click', 'button.o_ol_add_existing_family', this._onAddExistingRecord.bind(this));
        }
    },
})
...
const FieldEnrollIndividualToFamilyMany2many = FieldOne2Many.extend({
    ...
    _renderButtons() {
        ...
        if (!this.isReadonly && this.view.arch.tag === 'kanban' && this.$buttons
            ...
            this.$buttons.on('click', 'button.o_ol_add_existing_individual', this._onAddExistingRecord.bind(this));
            this.$buttons.on('click', 'button.o_ol_add_individual_in_form', this.onAddRecordInFormOpenDialog.bind(this));
        }
    },
})
