/** @odoo-module alias=ol_school_manager.SwitchSchoolMenu */
...
export class SwitchSchoolTree extends Component {
    static template = 'ol_school_manager.SwitchSchoolTree'
...
export class SwitchSchoolMenu extends Component {
    static template = 'ol_school_manager.SwitchSchoolMenu';
