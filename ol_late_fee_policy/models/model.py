...
#                 raise UserError(str(numberOfdays)+" : "+str(dif)+" : "+str(int(numberOfdays/dif))+" : "+str(charge+(charge*int(numberOfdays/dif))))
                charges[key]=2*charge+(charge*int(numberOfdays/dif))
