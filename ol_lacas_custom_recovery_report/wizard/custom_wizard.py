    ...
    def action_print_report(self):
        ...
        for month in selected_month:
            ...
            if self.all_branch==True:
                ...
                inv_ids=self.env['account.move'].search([('move_type','=','out_invoice'),('state','=','posted'),('journal_id','in',journal_list),('x_studio_current_branchschool','=',self.one_branch.id),('invoice_date',">=",self.from_date),('invoice_date',"<=",self.to_date)])
