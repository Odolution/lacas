...
class RecoveryReportWizard(models.TransientModel):
    ...
    def action_print_report(self):
        ...
        for rec in school_ids_raw:
            ...
            school_bill_id=self.env['account.move'].search([('program_ids','=',rec.program_ids.name),('state','=','posted')])
    ...
    def action_print_excel_school_branch_report(self):
        ...
        if xlwt:
            ...
            worksheet.write_merge(0,1,6,7,"App Date",style=red_style_title)
            worksheet.write_merge(0,1,8,9,"Branch Wise Recovery",style=red_style_title)
            worksheet.write_merge(0,1,10,11,"'%' age of Recovery",style=yellow_style_title)
