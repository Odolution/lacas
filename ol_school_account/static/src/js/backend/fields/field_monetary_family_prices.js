/** @odoo-module alias=ol.finance.field.family_prices */
...
class FieldOlFinanceMonetaryFamilyPrices extends AbstractField {
    static template = 'ol.finance.FieldMonetaryFamilyPrices';
...
field_registry.add('ol_finance_family_prices', FieldOlFinanceMonetaryFamilyPrices);

return FieldOlFinanceMonetaryFamilyPrices;